...
옛날 화면에 하나의 문자를 출력할때는 2바이트의 값을 써야합니다. 화면 한 줄이 80개의 문자를 출력할 수 있으니까 한 줄당 160바이트입니다. 350은 몇번째 줄일까요? 첫번째 줄은 0,2,4 ... 158, 두번째 줄은 160,162,164 ... 318, 세번째 줄이 320... 이므로 350이라는 값은 세번째 줄에 표시한다는 것입니다.
